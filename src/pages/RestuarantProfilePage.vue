<template>
  <q-page>
    ...
    <div class="q-pa-md text-center">
      <q-card>
        <q-img src="~assets/images/banner.jpg" style="height: 300px;" />
      </q-card>
        ...
        <q-tab-panels v-model="tab" animated>
            ...
            <div class="row">
              <div class="col q-pa-md">
                ...
                <p class="text-justify">
                  The food court provides you different types of foods that may
                  be snacks, meals or street foods. With the perfect location
                  and environment. With the Food Court it will take you too the
                  different..
                </p>
              </div>
              <div class="col q-pa-md">
                <b>History</b>
                <p class="text-justify">
                  The food court was established in the year 2016. It started as
                  a little vendor shop in Mindanao State University - main
          ...
          <q-tab-panel name="menu">
            ...
            <div class="row q-pa-sm">
              <p class="captions">
                ...
                Atay 2. Meals - Pater - Pater w/ palapa - Tapsilog - Longsilog
                3. Snacks - Chips - Beverages
              </p>
            </div>
          </q-tab-panel>
          ...
          <q-tab-panel name="reviews">
            ...
            <div class="q-pa-md text-left" style="full-width">
              <q-list v-for="(item, index) of Feedbacks">
                <q-item>
                  <q-item-section>
